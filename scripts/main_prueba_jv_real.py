# scripts/main_prueba_jv_real.py
"""
Prueba con Mercado Pago REAL (dinero real) + SOLO jabon_verde real
(bomba + sensor). Los otros 3 productos deshabilitados.
Correr: DISPLAY=:0 python3 scripts/main_prueba_jv_real.py
"""
import sys, os
...
log.info("=== Prueba SOLO jabon_verde - MERCADO PAGO REAL (dinero real) ===")
app.mainloop()
